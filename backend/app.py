...
class ComplexityEval:
    ...
    def evaluate(self):
        ...
        response = {
            "Vidējais teikuma garums": asl,
            "Vidējais vārda garums": longWords,
            "Vidējais zilbju garums vārdā": asw,
            "Zilbju saraksts": self.syllableize(words),
            "Sarežģītie vārdi teikumā (3+ zilbes)": complex_words,
            "Vidējo komatu skaits teikumā": avgCommas,
            "Latviesu valodas meginajuma aprēķins": lvLasamiba,
            "Latviesu valodas meginajuma klase": lvLasamiba_result,
            "Fleša lasīšanas viegluma aprēķins": flesch_reading_ease_result,
            "Fleša – Kinkeida lasīšanas viegluma klase": flesch_reading_grade_result,
            "Gunning fog indekss": gunning_fog_index_result,
            "Gunning fog klase": gunning_fog_index_grade,
            "Tiešās runas": directSpeechExamples,
            "Tiešo runu īpatsvars": directSpeechProportion,
            "Teikumi pēc to uzbūves": sentenceType,
            "Vienkāršo teikumu īpatsvars": simpleSentenceProportion,
            "Visi uzskaitītie vārdi": words,
            "Unikālie vārdi": lemmas,
            "Unikālo vārdu īpatsvars": TypeTokenRatio,
            "Reto vārdu īpatsvars": rarityProportion,
            "Nosauktās entitātes": NERExample,
            "Nosaukto entitāšu īpatsvars": NERRatio
        }
